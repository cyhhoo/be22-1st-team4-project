...
CREATE TABLE `TBL_PRODUCTS_PACKAGE_SPECS` (
	...
	CONSTRAINT `PK_TBL_PRODUCTS_PACKAGE_SPECS` PRIMARY KEY (
		`PRODUCT_CD`
	),
	CONSTRAINT `FK_TBL_PRODUCTS_TO_TBL_PRODUCTS_PACKAGE_SPECS_1` FOREIGN KEY (
		`PRODUCT_CD`
	)
...
CREATE TABLE `TBL_PRODUCTS_DRINK_SPECS` (
	...
	CONSTRAINT `PK_TBL_PRODUCTS_DRINK_SPECS` PRIMARY KEY (
		`PRODUCT_CD`
	),
	CONSTRAINT `FK_TBL_PRODUCTS_TO_TBL_PRODUCTS_DRINK_SPECS_1` FOREIGN KEY (
		`PRODUCT_CD`
	)
	REFERENCES `TBL_PRODUCTS` (
		`PRODUCT_CD`
...
CREATE TABLE `TBL_COMMENT` (
	...
	CONSTRAINT `PK_TBL_COMMENT` PRIMARY KEY (
		`COMMENT_CD`
	),
	CONSTRAINT `FK_TBL_USERS_TO_TBL_COMMENT_1` FOREIGN KEY (
		`USER_CD`
	)
	REFERENCES `TBL_USERS` (
		`USER_CD`
	),
	CONSTRAINT `FK_TBL_POSTS_TO_TBL_COMMENT_1` FOREIGN KEY (
		`POST_CD`
	)
...
CREATE TABLE `TBL_ORDER_DETAILS` (
	...
	CONSTRAINT `PK_TBL_ORDER_DETAILS` PRIMARY KEY (
		`ORDER_CD`,
		`VARIANT_CD`
	),
	CONSTRAINT `FK_TBL_ORDERS_TO_TBL_ORDER_DETAILS_1` FOREIGN KEY (
		`ORDER_CD`
	)
	REFERENCES `TBL_ORDERS` (
		`ORDER_CD`
	),
	CONSTRAINT `FK_TBL_PRODUCT_VARIANTS_TO_TBL_ORDER_DETAILS_1` FOREIGN KEY (
		`VARIANT_CD`
	)
...
CREATE TABLE `TBL_ST_PHY` (
	...
	CONSTRAINT `PK_TBL_ST_PHY` PRIMARY KEY (
		`ST_PHY_CD`
	)
);
...
CREATE TABLE `TBL_GFC_SEND_TYPE` (
	...
	CONSTRAINT `PK_TBL_GFC_SEND_TYPE` PRIMARY KEY (
		`GFC_SEND_TYPE_CD`
	)
);
...
CREATE TABLE `TBL_NOTIFICATIONS` (
	...
	CONSTRAINT `PK_TBL_NOTIFICATIONS` PRIMARY KEY (
		`NOTI_CD`
	),
	CONSTRAINT `FK_TBL_USERS_TO_TBL_NOTIFICATIONS_1` FOREIGN KEY (
		`USER_CD`
	)
	REFERENCES `TBL_USERS` (
		`USER_CD`
...
CREATE TABLE `TBL_POSTS` (
	...
	CONSTRAINT `PK_TBL_POSTS` PRIMARY KEY (
		`POST_CD`
	),
	CONSTRAINT `FK_TBL_USERS_TO_TBL_POSTS_1` FOREIGN KEY (
		`USER_CD`
	)
	REFERENCES `TBL_USERS` (
		`USER_CD`
	),
	CONSTRAINT `FK_TBL_POST_CATEGORIES_TO_TBL_POSTS_1` FOREIGN KEY (
		`POST_CTGRY_CD`
	)
...
CREATE TABLE `TBL_POST_CATEGORIES` (
	...
	CONSTRAINT `PK_TBL_POST_CATEGORIES` PRIMARY KEY (
		`POST_CTGRY_CD`
	)
);
...
CREATE TABLE `TBL_PRODUCTS` (
	...
	CONSTRAINT `PK_TBL_PRODUCTS` PRIMARY KEY (
		`PRODUCT_CD`
	),
	CONSTRAINT `FK_TBL_PRODUCT_TYPE_TO_TBL_PRODUCTS_1` FOREIGN KEY (
		`PRODUCT_TYPE_CD`
	)
	REFERENCES `TBL_PRODUCT_TYPE` (
		`PRODUCT_TYPE_CD`
	),
	CONSTRAINT `FK_TBL_PRODUCT_CATEGORIES_TO_TBL_PRODUCTS_1` FOREIGN KEY (
		`PRODUCT_CTGRY_CD`
	)
...
CREATE TABLE `TBL_PEOPLE` (
	...
	CONSTRAINT `PK_TBL_PEOPLE` PRIMARY KEY (
		`PERSON_CD`
	)
);
...
CREATE TABLE `TBL_COUPONS` (
	...
	CONSTRAINT `PK_TBL_COUPONS` PRIMARY KEY (
		`COUPON_CD`
	),
	CONSTRAINT `FK_TBL_COUPON_DISCOUNT_GB_TO_TBL_COUPONS_1` FOREIGN KEY (
		`DISCOUNT_GB`
	)
...
CREATE TABLE `TBL_PRODUCT_CATEGORIES` (
	...
	CONSTRAINT `PK_TBL_PRODUCT_CATEGORIES` PRIMARY KEY (
		`PRODUCT_CTGRY_CD`
	)
);
...
CREATE TABLE `TBL_GENRES` (
	...
	CONSTRAINT `PK_TBL_GENRES` PRIMARY KEY (
		`GENRE_CD`
	)
);
...
CREATE TABLE `TBL_PRODUCT_VARIANTS` (
	...
	CONSTRAINT `PK_TBL_PRODUCT_VARIANTS` PRIMARY KEY (
		`VARIANT_CD`
	),
	CONSTRAINT `FK_TBL_PRODUCTS_TO_TBL_PRODUCT_VARIANTS_1` FOREIGN KEY (
		`PRODUCT_CD`
	)
	REFERENCES `TBL_PRODUCTS` (
		`PRODUCT_CD`
	),
	CONSTRAINT `FK_TBL_VARIANT_SALE_GB_TO_TBL_PRODUCT_VARIANTS_1` FOREIGN KEY (
		`VARIANT_SALE_GB`
	)
...
CREATE TABLE `TBL_CARTS` (
	...
	CONSTRAINT `PK_TBL_CARTS` PRIMARY KEY (
		`USER_CD`,
		`VARIANT_CD`
	),
	CONSTRAINT `FK_TBL_USERS_TO_TBL_CARTS_1` FOREIGN KEY (
		`USER_CD`
	)
	REFERENCES `TBL_USERS` (
		`USER_CD`
	),
	CONSTRAINT `FK_TBL_PRODUCT_VARIANTS_TO_TBL_CARTS_1` FOREIGN KEY (
		`VARIANT_CD`
	)
	REFERENCES `TBL_PRODUCT_VARIANTS` (
		`VARIANT_CD`
...
CREATE TABLE `TBL_POST_IMAGES` (
	...
	CONSTRAINT `PK_TBL_POST_IMAGES` PRIMARY KEY (
		`POST_IMAGE_CD`
	),
	CONSTRAINT `FK_TBL_POSTS_TO_TBL_POST_IMAGES_1` FOREIGN KEY (
		`POST_CD`
	)
	REFERENCES `TBL_POSTS` (
		`POST_CD`
...
CREATE TABLE `TBL_GFC_SEND` (
	...
	CONSTRAINT `PK_TBL_GFC_SEND` PRIMARY KEY (
		`GFC_SEND_CD`
	),
	CONSTRAINT `FK_TBL_GFC_SEND_ST_TO_TBL_GFC_SEND_1` FOREIGN KEY (
		`GFC_SEND_ST_CD`
	)
	REFERENCES `TBL_GFC_SEND_ST` (
		`GFC_SEND_ST_CD`
	),
	CONSTRAINT `FK_TBL_GFC_SEND_TYPE_TO_TBL_GFC_SEND_1` FOREIGN KEY (
		`GFC_SEND_TYPE_CD`
	)
...
CREATE TABLE `TBL_USER_SOCIAL_ACCOUNTS` (
	...
	CONSTRAINT `PK_TBL_USER_SOCIAL_ACCOUNTS` PRIMARY KEY (
		`SOCIAL_ACCOUNT_CD`
	),
	CONSTRAINT `FK_TBL_USERS_TO_TBL_USER_SOCIAL_ACCOUNTS_1` FOREIGN KEY (
		`USER_CD`
	)
	REFERENCES `TBL_USERS` (
		`USER_CD`
...
CREATE TABLE `TBL_MOVIE_CAST` (
	...
	CONSTRAINT `PK_TBL_MOVIE_CAST` PRIMARY KEY (
		`PERSON_CD`,
		`MOVIE_CD`
	),
	CONSTRAINT `FK_TBL_PEOPLE_TO_TBL_MOVIE_CAST_1` FOREIGN KEY (
		`PERSON_CD`
	)
	REFERENCES `TBL_PEOPLE` (
		`PERSON_CD`
	),
	CONSTRAINT `FK_TBL_MOVIES_TO_TBL_MOVIE_CAST_1` FOREIGN KEY (
		`MOVIE_CD`
	)
...
CREATE TABLE `TBL_PRODUCT_TYPE` (
	...
	CONSTRAINT `PK_TBL_PRODUCT_TYPE` PRIMARY KEY (
		`PRODUCT_TYPE_CD`
	)
);
...
CREATE TABLE `TBL_ORDER_HISTORY` (
	...
	CONSTRAINT `PK_TBL_ORDER_HISTORY` PRIMARY KEY (
		`ORD_HIST_CD`
	),
	CONSTRAINT `FK_TBL_ORDERS_TO_TBL_ORDER_HISTORY_1` FOREIGN KEY (
		`ORDER_CD`
	)
	REFERENCES `TBL_ORDERS` (
		`ORDER_CD`
...
CREATE TABLE `TBL_MOVIE_GENRES` (
	...
	CONSTRAINT `PK_TBL_MOVIE_GENRES` PRIMARY KEY (
		`GENRE_CD`,
		`MOVIE_CD`
	),
	CONSTRAINT `FK_TBL_GENRES_TO_TBL_MOVIE_GENRES_1` FOREIGN KEY (
		`GENRE_CD`
	)
	REFERENCES `TBL_GENRES` (
		`GENRE_CD`
	),
	CONSTRAINT `FK_TBL_MOVIES_TO_TBL_MOVIE_GENRES_1` FOREIGN KEY (
		`MOVIE_CD`
	)
	REFERENCES `TBL_MOVIES` (
		`MOVIE_CD`
...
CREATE TABLE `TBL_USER_COUPONS` (
	...
	CONSTRAINT `PK_TBL_USER_COUPONS` PRIMARY KEY (
		`USER_COUPON_CD`
	),
	CONSTRAINT `FK_TBL_USERS_TO_TBL_USER_COUPONS_1` FOREIGN KEY (
		`USER_CD`
	)
	REFERENCES `TBL_USERS` (
		`USER_CD`
	),
	CONSTRAINT `FK_TBL_COUPONS_TO_TBL_USER_COUPONS_1` FOREIGN KEY (
		`COUPON_CD`
	)
...
CREATE TABLE `TBL_COUPON_DISCOUNT_GB` (
	...
	CONSTRAINT `PK_TBL_COUPON_DISCOUNT_GB` PRIMARY KEY (
		`DISCOUNT_GB`
	)
);
...
CREATE TABLE `TBL_VARIANT_SALE_GB` (
	...
	CONSTRAINT `PK_TBL_VARIANT_SALE_GB` PRIMARY KEY (
		`VARIANT_SALE_GB`
	)
);
...
CREATE TABLE `TBL_GFC_SEND_ST` (
	...
	CONSTRAINT `PK_TBL_GFC_SEND_ST` PRIMARY KEY (
		`GFC_SEND_ST_CD`
	)
);
...
CREATE TABLE `TBL_DELIVERY_PHY` (
	...
	CONSTRAINT `PK_TBL_DELIVERY_PHY` PRIMARY KEY (
		`DELIVERY_PHY_CD`
	),
	CONSTRAINT `FK_TBL_ST_PHY_TO_TBL_DELIVERY_PHY_1` FOREIGN KEY (
		`ST_PHY_CD`
	)
...
CREATE TABLE `TBL_GFC_ORDER` (
	...
	CONSTRAINT `PK_TBL_GFC_ORDER` PRIMARY KEY (
		`ORDER_CD`
	),
	CONSTRAINT `FK_TBL_ORDERS_TO_TBL_GFC_ORDER_1` FOREIGN KEY (
		`ORDER_CD`
	)
	REFERENCES `TBL_ORDERS` (
		`ORDER_CD`
	),
	CONSTRAINT `FK_TBL_GFC_SEND_TO_TBL_GFC_ORDER_1` FOREIGN KEY (
		`GFC_SEND_CD`
	)
...
CREATE TABLE `TBL_ORDERS` (
	...
	CONSTRAINT `PK_TBL_ORDERS` PRIMARY KEY (
		`ORDER_CD`
	),
	CONSTRAINT `FK_TBL_USERS_TO_TBL_ORDERS_1` FOREIGN KEY (
		`USER_CD`
	)
	REFERENCES `TBL_USERS` (
		`USER_CD`
	),
	CONSTRAINT `FK_TBL_PRODUCT_TYPE_TO_TBL_ORDERS_1` FOREIGN KEY (
		`PRODUCT_TYPE_CD`
	)
	REFERENCES `TBL_PRODUCT_TYPE` (
		`PRODUCT_TYPE_CD`
	),
	CONSTRAINT `FK_TBL_COUPONS_TO_TBL_ORDERS_1` FOREIGN KEY (
		`COUPON_CD`
	)
	REFERENCES `TBL_COUPONS` (
		`COUPON_CD`
...
CREATE TABLE `TBL_PRODUCTS_GOODS_SPECS` (
	...
	CONSTRAINT `PK_TBL_PRODUCTS_GOODS_SPECS` PRIMARY KEY (
		`PRODUCT_CD`
	),
	CONSTRAINT `FK_TBL_PRODUCTS_TO_TBL_PRODUCTS_GOODS_SPECS_1` FOREIGN KEY (
		`PRODUCT_CD`
	)
	REFERENCES `TBL_PRODUCTS` (
		`PRODUCT_CD`
...
CREATE TABLE `TBL_USERS` (
	...
	CONSTRAINT `PK_TBL_USERS` PRIMARY KEY (
		`USER_CD`
	)
);
...
CREATE TABLE `TBL_ORDER_PHY` (
	...
	CONSTRAINT `PK_TBL_ORDER_PHY` PRIMARY KEY (
		`ORDER_CD`
	),
	CONSTRAINT `FK_TBL_ORDERS_TO_TBL_ORDER_PHY_1` FOREIGN KEY (
		`ORDER_CD`
	)
	REFERENCES `TBL_ORDERS` (
		`ORDER_CD`
	),
	CONSTRAINT `FK_TBL_DELIVERY_PHY_TO_TBL_ORDER_PHY_1` FOREIGN KEY (
		`DELIVERY_PHY_CD`
	)
...
CREATE TABLE `TBL_INQUIRIES` (
	...
	CONSTRAINT `PK_TBL_INQUIRIES` PRIMARY KEY (
		`INQUIRY_CD`
	),
	CONSTRAINT `FK_TBL_USERS_TO_TBL_INQUIRIES_1` FOREIGN KEY (
		`USER_CD`
	)
	REFERENCES `TBL_USERS` (
		`USER_CD`
...
CREATE TABLE `TBL_PRODUCTS_FOOD_SPECS` (
	...
	CONSTRAINT `PK_TBL_PRODUCTS_FOOD_SPECS` PRIMARY KEY (
		`PRODUCT_CD`
	),
	CONSTRAINT `FK_TBL_PRODUCTS_TO_TBL_PRODUCTS_FOOD_SPECS_1` FOREIGN KEY (
		`PRODUCT_CD`
	)
	REFERENCES `TBL_PRODUCTS` (
		`PRODUCT_CD`
...
-- =======================================================================
-- TBL_REVIEWS (참고: 원본 파일에 CREATE TABLE 구문이 누락되어 제약 조건은 추가할 수 없습니다.)
-- 원본 파일에 있던 TBL_REVIEWS 제약 조건:
-- ALTER TABLE `TBL_REVIEWS` ADD CONSTRAINT `PK_TBL_REVIEWS` PRIMARY KEY (`REVIEW_CD`);
-- ALTER TABLE `TBL_REVIEWS` ADD CONSTRAINT `FK_TBL_USERS_TO_TBL_REVIEWS_1` FOREIGN KEY (`USER_CD`) REFERENCES `TBL_USERS` (`USER_CD`);
-- ALTER TABLE `TBL_REVIEWS` ADD CONSTRAINT `FK_TBL_MOVIES_TO_TBL_REVIEWS_1` FOREIGN KEY (`MOVIE_CD`) REFERENCES `TBL_MOVIES` (`MOVIE_CD`);
-- =======================================================================
